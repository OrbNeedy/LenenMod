...
namespace lenen.Content.Items.Accessories.Misc
{
    public class ThrillEngine : ModItem
    {
        ...
        {
            Texture2D engine = ModContent.Request<Texture2D>("lenen/Content/Items/Accessories/Misc/ThrillEngine").Value;
            Texture2D glowmask = ModContent.Request<Texture2D>("lenen/Content/Items/Accessories/Misc/ThrillEngineGlowmask").Value;
            Texture2D bigGlow = ModContent.Request<Texture2D>("lenen/Content/Items/Accessories/Misc/ThrillEngineGlowmask2").Value;
            Texture2D glass = ModContent.Request<Texture2D>("lenen/Content/Items/Accessories/Misc/ThrillEngineGlowmask2Glass").Value;
