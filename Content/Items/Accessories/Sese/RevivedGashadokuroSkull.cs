...
namespace lenen.Content.Items.Accessories.Sese
{
    ...
    public class RevivedGashadokuroSkull : ModItem
    {
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            } else
            {
                ...
                {
                    if (soulsCollected >= maxSouls || player.GetModPlayer<BuffPlayer>().Cheating)
                    {
        ...
        {
            Recipe.OnCraftCallback callback = new((recipe, item, list, item2) => 
            { 
