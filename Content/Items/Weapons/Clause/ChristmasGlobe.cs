...
{
    public class ChristmasGlobe : SpellCardItem
    {
        protected override SpellCard SpellCardID => Common.Players.SpellCard.SuperPresent;
        ...
        protected override void SpellCard(Player player, bool desperate)
        {
            ...
            Projectile.NewProjectile(player.GetSource_ItemUse(Item, "Spellcard"), 
                player.Center, vel, gravityType, 0, 0, player.whoAmI, desperation, 0);
        }
