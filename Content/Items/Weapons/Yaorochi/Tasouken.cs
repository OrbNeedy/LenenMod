...
namespace lenen.Content.Items.Weapons.Yaorochi
{
    public class Tasouken : SpellCardItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (!powerProven && NPC.downedGolemBoss)
            {
                ...
                if (index != -1)
                {
                    string state = Language.GetTextValue("Mods.lenen.Items.Tasouken.Challenging");
                    tooltips.Insert(index + 1, new TooltipLine(Mod, "TasoukenState", state));
                }
            }
            if (powerProven)
            {
                ...
                if (index != -1)
                {
                    string state = Language.GetTextValue("Mods.lenen.Items.Tasouken.Unlocked");
                    tooltips.Insert(index + 1, new TooltipLine(Mod, "TasoukenState", state));
                }
            }
        }
