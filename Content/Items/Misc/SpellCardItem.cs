...
namespace lenen.Content.Items.Misc
{
    ...
    public abstract class SpellCardItem : ModItem
    {
        ...
        {
            if (player.GetModPlayer<BuffPlayer>().Cheating) return true;
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (index != -1)
            {
                ...
                string name = SpellCardManagement.spellcardData[SpellCardID].name;
                if (desperate)
                {
                    name = SpellCardManagement.spellcardData[SpellCardID].desperateName;
                }

                string newDescription = Language.GetTextValue(
                    "Mods.lenen.SpellCardDescription", finalCooldown, name);
            ...
            if (index != -1)
            {
                ...
                string newDescription = Language.GetTextValue(
                    "Mods.lenen.SpellCardManaDescription", ManaUse, finalCooldown, name);
