...
namespace lenen.Content.Items.Materials
{
    public class LumenDiscFragment : ModItem
    {
        ...
        public override string Texture => $"lenen/Content/Items/Materials/LumenDiscFragment_{fragmentFrame}";

        public override bool PreDrawInInventory(SpriteBatch spriteBatch, Vector2 position, Rectangle frame, Color drawColor, Color itemColor, Vector2 origin, float scale)
        {
            Texture2D fragment = 
                ModContent.Request<Texture2D>($"lenen/Content/Items/Materials/LumenDiscFragment_{fragmentFrame}").Value;
